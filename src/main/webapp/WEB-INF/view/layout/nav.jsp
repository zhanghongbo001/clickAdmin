            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="jTab" data-url="" data-title="用户管理" href="javascript:;"><i class="fa fa-user fa-fw"></i>用户管理</a>
                            <a class="jTab" data-url="" data-title="权限设置" href="javascript:;"><i class="fa fa-wrench fa-fw"></i>权限设置</a>
                        </li>
                    </ul>
                </li>
            </ul>
